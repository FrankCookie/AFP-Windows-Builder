...
if __name__ == '__main__':
    ...
    print("  修复内容:")
    print("    ✅🔥 视频最大高度限制 60vh（无论什么比例都不溢出）")
    print("    ✅🔥 object-fit: contain（保持比例，不裁剪）")
    print("    ✅🔥 添加播放速度控制（0.5x/0.75x/1x/1.5x/2x）")
    print("    ✅🔥 左右面板最大高度 85vh + 滚动")
    print("    ✅🔥 防止水平溢出（overflow-x: hidden）")
    print("    ✅ 保留所有分析功能和AFP配色")
    print()
    print("=" * 70)
    print()
